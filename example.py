...
class Title(SlideScene):
    def construct(self):
        title = Text("ทดสอบ Reveal.js").scale(1.25).shift(2.5*UP)
        name = Text("สกุลบุตร เอกวิทยานิพนธ์", font = "Chulabhorn Likit Text").next_to(title, DOWN)
